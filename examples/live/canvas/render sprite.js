(() => {
  ...
  // ../phaser-genesis/src/config/canvascontext/GetCanvasContext.ts
  function GetCanvasContext() {
    return ConfigStore.get(CONFIG_DEFAULTS.CANVAS_CONTEXT);
  }

  // ../phaser-genesis/src/renderer/canvas/CanvasRenderer.ts
  ...
  // ../phaser-genesis/src/config/canvas/Canvas.ts
  function Canvas() {
    return () => {
  ...
  // examples/src/canvas/render sprite.ts
  ...
  new Game(Canvas(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960685), Scenes(Demo));
})();
/**
 ...
 * @license      {@link https://opensource.org/licenses/MIT|MIT License}
 */
//# sourceMappingURL=render sprite.js.map
