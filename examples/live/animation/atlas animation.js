(() => {
  ...
  // ../phaser-genesis/src/gameobjects/animatedsprite/AddAnimationFromAtlas.ts
  ...
  // ../phaser-genesis/src/components/transform/TransformComponent.ts
  ...
  // ../phaser-genesis/src/gameobjects/animatedsprite/Play.ts
...
void main (void)
{
  ...
  // examples/src/animation/atlas animation.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        Play("lay", {repeat: -1, speed: 16, delay: 1e3, repeatDelay: 4e3}, chicken1);
        Play("idle", {repeat: -1, speed: 24, repeatDelay: 1e3}, chicken2);
        Play("peck", {repeat: -1, speed: 24, delay: 2e3, repeatDelay: 3e3}, chicken3);
