(() => {
  ...
  // ../phaser-1/src/display/GetBounds.ts
  ...
  // ../phaser-1/src/display/SetBounds.ts
...
void main (void)
{
  ...
  // ../phaser-1/src/math/mat2d/Mat2dAppend.ts
  ...
  // ../phaser-1/src/math/mat2d/Mat2dGlobalToLocal.ts
  ...
  // ../phaser-1/src/input/mouse/Mouse.ts
  ...
  // ../phaser-1/src/loader/ImageTagLoader.ts
  ...
  // ../phaser-1/src/loader/files/ImageFile.ts
  ...
  // ../phaser-1/src/input/SetInteractive.ts
  ...
  // examples/src/container/deep children.ts
  var Demo = class extends Scene {
    ...
    create() {
      ...
      for (let i = wB.x; i < wB.right; i += starDiameter) {
        let container = new Rectangle2(i, i, starDiameter, starDiameter, Between(0, 16777215));
      ...
      On(mouse, "pointerup", (_x, _y) => target = void 0);
      On(this, "update", (delta, time) => {
        ...
        for (let i2 = 0; i2 < 1024; ++i2) {
          ...
          let adopter = new Rectangle2(Math.sign(dx), Math.sign(dy), bounds.width, bounds.height, Between(0, 16777215));
 ...
 * @license      {@link https://opensource.org/licenses/MIT|MIT License}
 */
//# sourceMappingURL=deep children.js.map
