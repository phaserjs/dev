(() => {
  ...
  // ../phaser-1/src/config/webglcontext/SetWebGLContext.ts
...
void main (void)
{
  ...
  // ../phaser-1/src/components/transform/TRANSFORM_CONST.ts
  var TRANSFORM_CONST = {
    X: 0,
    Y: 1,
    ROTATION: 2,
  ...
  // ../phaser-1/src/renderer/canvas/draw/DrawImage.ts
  ...
  // ../phaser-1/src/math/RadToDeg.ts
  function RadToDeg(radians) {
    return radians * MATH_CONST.RAD_TO_DEG;
  }

  // ../phaser-1/src/input/keyboard/keys/index.ts
  var keys_exports = {};
  ...
  // ../phaser-1/src/input/keyboard/Key.ts
  var Key = class {
    constructor(value) {
      this.capture = true;
      this.isDown = false;
  ...
  // ../phaser-1/src/input/keyboard/keys/AKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/ArrowKeys.ts
  var ArrowKeys = class {
  ...
  // ../phaser-1/src/input/keyboard/keys/BKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/CKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/DKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/DownKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/EKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/FKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/GKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/HKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/IKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/JKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/KKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/LKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/LeftKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/MKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/NKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/OKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/PKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/QKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/RKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/RightKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/SKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/SpaceKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/TKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/UKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/UpKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/VKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/WASDKeys.ts
  var WASDKeys = class {
    constructor(keyboardManager, config) {
      const {
        W = true,
  ...
  // ../phaser-1/src/input/keyboard/keys/WKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/XKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/YKey.ts
  ...
  // ../phaser-1/src/input/keyboard/keys/ZKey.ts
  ...
  // ../phaser-1/src/input/keyboard/Keyboard.ts
  ...
  // ../phaser-1/src/geom/rectangle/GetRectangleCenterX.ts
  function GetRectangleCenterX(rect) {
    return rect.x + rect.width / 2;
  }

  // ../phaser-1/src/geom/rectangle/GetRectangleCenterY.ts
  function GetRectangleCenterY(rect) {
    return rect.y + rect.height / 2;
  }

  // examples/src/container/armature.ts
  var _Arm = class extends Container {
    constructor(x, y) {
      super(x, y);
      this.parts = {
        shoulder: new Rectangle2(0, 0, 64, 128, 15728640).setOrigin(0.5, 0.05),
        elbow: new Rectangle2(0, 0, 32, 64, 14680064).setOrigin(0.5, 0.05),
        wrist: new Rectangle2(0, 0, 24, 64, 13631488).setOrigin(0.5, 0.05),
        palm: new Rectangle2(0, 0, 32, 16, 12582912).setOrigin(0.5, 0.5),
        thumb: new Rectangle2(0, 0, 8, 16, 61440).setOrigin(0.5, 0.05),
        finger: new Rectangle2(0, 0, 8, 16, 240).setOrigin(0.5, 0.05)
      };
      AddChild(this, this.parts.shoulder);
      AddChild(this.parts.shoulder, this.parts.elbow);
      this.parts.elbow.y = this.parts.shoulder.height * 0.95;
      AddChild(this.parts.elbow, this.parts.wrist);
      this.parts.wrist.y = this.parts.elbow.height * 0.95;
      AddChild(this.parts.wrist, this.parts.palm);
      this.parts.palm.y = this.parts.wrist.height * 0.95;
    ...
    handlePart(delta, partkey) {
      const part = this.parts[partkey];
      for (let [key, target] of Object.entries(_Arm.restitution[partkey])) {
        let value = part[key];
        ...
        switch (partkey) {
          case "palm": {
            let minmax = _Arm.palmKeys[key];
            dKey = +!!minmax.max.isDown - +!!minmax.min.isDown;
            break;
          }
          default:
            dKey = +!!_Arm.keys[partkey].isDown;
            break;
        }
        let speed = 0;
        if (dKey == 0) {
  ...
  var Arm = _Arm;
  Arm.keys = {
    shoulder: new keys_exports.QKey(),
    elbow: new keys_exports.WKey(),
    wrist: new keys_exports.EKey(),
    down: new keys_exports.DownKey(),
    up: new keys_exports.UpKey(),
    left: new keys_exports.LeftKey(),
    right: new keys_exports.RightKey(),
    thumb: new keys_exports.RKey(),
    finger: new keys_exports.TKey()
  };
  Arm.palmKeys = {
    scaleX: {
      min: _Arm.keys.left,
  ...
  var Demo = class extends Scene {
    constructor() {
      ...
      let keys = __spreadValues({
        space: (() => {
          let key = new keys_exports.SpaceKey();
          key.canRepeat = false;
          return key;
        })()
      }, Arm.keys);
