...
void main (void)
{
  ...
  function SetTexture2(texture, frame2, ...children) {
  ...
  // ../phaser-genesis/src/textures/GetSpritesWithTexture.ts
  function GetSpritesWithTexture(texture, frame2) {
    const { texture: srcTexture } = ReturnTexture(texture, frame2);
    let children;
    if (srcTexture) {
      const eids = srcTexture.inUseQuery(GameObjectWorld);
      children = eids.map((id) => GameObjectCache.get(id));
    }
    return children;
  }
  ...
  // examples/src/textures/get sprites with texture.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      loader.add(ImageFile("disk", "assets/items/disk1.png"), ImageFile("floppy", "assets/items/floppy2.png"), ImageFile("tape", "assets/items/tape3.png"), ImageFile("record", "assets/items/record4.png"), ImageFile("flower", "assets/items/flower5.png"), ImageFile("book", "assets/items/book6.png"));
      await loader.start();
      ...
      for (let i = 0; i < 64; i++) {
        ...
        AddChild(world2, new Sprite(x, y, GetRandom(frames)));
      }
      setTimeout(() => {
 ...
 */
//# sourceMappingURL=get sprites with texture.js.map
