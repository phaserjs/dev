(() => {
  ...
  // d:/wamp/www/phaser-genesis/src/config/maxtextures/MaxTextures.ts
...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/textures/set max textures 1.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      loader.add(ImageFile("disk1", "assets/items/disk1.png"), ImageFile("disk2", "assets/items/disk2.png"), ImageFile("disk3", "assets/items/disk3.png"), ImageFile("disk4", "assets/items/disk4.png"), ImageFile("disk5", "assets/items/disk5.png"), ImageFile("disk6", "assets/items/disk6.png"), ImageFile("disk7", "assets/items/disk7.png"));
      await loader.start();
      const world2 = new StaticWorld(this);
      let x = 64;
      let y = 64;
      for (let i = 1; i < 8; i++) {
        AddChild(world2, new Sprite(x, y, `disk${i}`));
        x += 64;
      }
    }
  };
