...
void main (void)
{
    ...
    return async (loader) => {
      try {
        ...
        if (entry.type === "PVR") {
          ...
          console.log("PVR", textureData);
        } else if (entry.type === "KTX") {
          textureData = KTXParser(image.data);
          console.log("KTX", textureData);
        }
        if (textureData && SupportsCompressedTexture(entry.format, textureData.internalFormat)) {
          ...
          console.log("format", textureData.format);
  ...
  // ../phaser-genesis/src/loader/files/LoadTextureFile.ts
  ...
  // examples/src/textures/compressed textures.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddChild(world2, labs);
      AddChild(world2, debug);
    }
  };
