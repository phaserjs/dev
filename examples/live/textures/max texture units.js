...
void main (void)
{
  ...
  // examples/src/textures/max texture units.ts
  var Demo = class extends Scene {
    ...
    create() {
      return __async(this, null, function* () {
        ...
        yield ImageFile("floppy1", "assets/items/floppy1.png").load();
        yield ImageFile("floppy2", "assets/items/floppy2.png").load();
        yield ImageFile("floppy3", "assets/items/floppy3.png").load();
        yield ImageFile("floppy4", "assets/items/floppy4.png").load();
        yield ImageFile("floppy5", "assets/items/floppy5.png").load();
        yield ImageFile("floppy6", "assets/items/floppy6.png").load();
        yield ImageFile("floppy7", "assets/items/floppy7.png").load();
        yield ImageFile("tape1", "assets/items/tape1.png").load();
        yield ImageFile("tape2", "assets/items/tape2.png").load();
        yield ImageFile("tape3", "assets/items/tape3.png").load();
        yield ImageFile("tape4", "assets/items/tape4.png").load();
        yield ImageFile("tape5", "assets/items/tape5.png").load();
        yield ImageFile("tape6", "assets/items/tape6.png").load();
        yield ImageFile("tape7", "assets/items/tape7.png").load();
        yield ImageFile("record1", "assets/items/record1.png").load();
        yield ImageFile("record2", "assets/items/record2.png").load();
        yield ImageFile("record3", "assets/items/record3.png").load();
        yield ImageFile("record4", "assets/items/record4.png").load();
        yield ImageFile("record5", "assets/items/record5.png").load();
        yield ImageFile("record6", "assets/items/record6.png").load();
        yield ImageFile("record7", "assets/items/record7.png").load();
        yield ImageFile("flower1", "assets/items/flower1.png").load();
        yield ImageFile("flower2", "assets/items/flower2.png").load();
        yield ImageFile("flower3", "assets/items/flower3.png").load();
        yield ImageFile("flower4", "assets/items/flower4.png").load();
        yield ImageFile("flower5", "assets/items/flower5.png").load();
        yield ImageFile("flower6", "assets/items/flower6.png").load();
        yield ImageFile("flower7", "assets/items/flower7.png").load();
        yield ImageFile("book1", "assets/items/book1.png").load();
        yield ImageFile("book2", "assets/items/book2.png").load();
        yield ImageFile("book3", "assets/items/book3.png").load();
        yield ImageFile("book4", "assets/items/book4.png").load();
        yield ImageFile("book5", "assets/items/book5.png").load();
