...
void main (void)
{
  ...
  // examples/src/gameobjects/animatedsprite/create animation from atlas.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        Play(peckAnimation, { repeat: -1, repeatDelay: 1e3 }, chicken1);
        console.log(chicken1);
        AddChildren(world2, bg, chicken1);
      });
    }
  };
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(0), Scenes(Demo));
})();
//# sourceMappingURL=create animation from atlas.js.map
