...
void main (void)
{
  ...
  function RenderChild(renderPass, id, x, y, right, bottom, renderData) {
...
void main( void ) {
  ...
  var Demo = class extends Scene {
    constructor() {
      ...
      const rect = new Rectangle2(400, 300, 512, 512, 16711935);
      const rect2 = new Rectangle2(400, 300, 256, 256, 16776960);
      On(world2, "update", () => {
        rect.rotation += 0.01;
        rect2.rotation -= 5e-3;
      });
