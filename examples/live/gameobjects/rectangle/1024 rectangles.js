...
void main (void)
{
  ...
  // ../phaser-genesis/src/color/Color.ts
  var Color2 = class {
    rgba;
  ...
  function GetColorSpectrum(limit = 1024) {
    ...
    let b = 0;
    for (i = 0; i <= range; i++) {
      colors.push(new Color2(r, i, b));
    }
    g = 255;
    for (i = range; i >= 0; i--) {
      colors.push(new Color2(i, g, b));
    }
    r = 0;
    for (i = 0; i <= range; i++, g--) {
      colors.push(new Color2(r, g, i));
    }
    g = 0;
    b = 255;
    for (i = 0; i <= range; i++, b--, r++) {
      colors.push(new Color2(r, g, b));
    }
    if (limit === 1024) {
      return colors;
    } else {
  ...
  var Demo = class extends Scene {
    constructor() {
      ...
      colors.forEach((color) => {
        const rect = new Rectangle2(x, y, 15, 23, color.getColor());
