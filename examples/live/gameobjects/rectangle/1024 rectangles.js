...
void main (void)
{
  ...
  // examples/src/gameobjects/rectangle/1024 rectangles.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      colors.forEach((color) => {
        const rect = new Rectangle2(x, y, 15, 23, color);
        AddChild(world2, rect);
        x = Wrap(x + 16, 0, 768);
        if (x === 0) {
          y += 24;
        }
  ...
  new Game(DefaultOrigin(0, 0), WebGL(), GlobalVar("Phaser4"), Parent("gameParent"), BackgroundColor(0), Scenes(Demo));
})();
//# sourceMappingURL=1024 rectangles.js.map
