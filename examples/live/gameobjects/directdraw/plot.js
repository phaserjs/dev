...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/gameobjects/directdraw/plot.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      dd.render = () => {
        dd.plot(100, 100, 16777215);
        dd.plot(200, 100, 16777215);
        dd.plot(300.5, 100, 16777215);
        dd.plot(400, 100.5, 16777215);
      };
      AddChild(world2, dd);
    }
  };
