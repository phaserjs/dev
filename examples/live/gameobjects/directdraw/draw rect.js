...
void main (void)
{
  ...
  var DirectDraw = class extends GameObject {
    ...
    fillRect(x, y, width, height, color, alpha = 1) {
      FillRect(this.renderPass, x, y, width, height, color, alpha);
      return this;
    }
    fillTriangle(x1, y1, x2, y2, x3, y3, color, alpha = 1) {
      FillTriangle(this.renderPass, x1, y1, x2, y2, x3, y3, color, alpha);
      return this;
    }
    fillLine(x0, y0, x1, y1, width, color, alpha = 1) {
      FillLine(this.renderPass, x0, y0, x1, y1, width, color, alpha);
      return this;
    }
    drawImage(texture, x, y, alpha = 1, scaleX = 1, scaleY = 1) {
      DrawImage(this.renderPass, texture, x, y, alpha, scaleX, scaleY);
      return this;
    }
    drawImagePart(texture, x0, y0, x1, y1, dx, dy, dw, dh, alpha = 1) {
      DrawImagePart(this.renderPass, texture, x0, y0, x1, y1, dx, dy, dw, dh, alpha);
      return this;
    }
    drawFrame(texture, frame2, x, y, alpha = 1, scaleX = 1, scaleY = 1) {
      DrawFrame(this.renderPass, texture, frame2, x, y, alpha, scaleX, scaleY);
      return this;
    }
    drawQuad(texture, frame2, x0, y0, x1, y1, x2, y2, x3, y3, alpha = 1) {
...
void main (void)
{
  ...
  // examples/src/gameobjects/directdraw/draw rect.ts
  var Demo = class extends Scene {
    ...
    create() {
      return __async(this, null, function* () {
        yield ImageFile("logo", "assets/logo.png");
        const world3 = new StaticWorld(this);
        const dd = new DirectDraw();
        dd.render = () => {
          dd.fillRect(100, 100, 340, 240, 16711680);
          dd.fillRect(200, 200, 512, 64, 16776960, 0.6);
          dd.fillRect(300, 300, 48, 210, 16711935);
        };
        AddChild(world3, dd);
      });
    }
