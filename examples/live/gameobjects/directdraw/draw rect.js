...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/gameobjects/directdraw/draw rect.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      dd.render = () => {
        dd.rect(100, 100, 340, 240, 16711680);
        dd.alpha = 0.6;
        dd.rect(200, 200, 512, 64, 16776960);
        dd.alpha = 1;
        dd.rect(300, 300, 48, 210, 16711935);
      };
      AddChild(world2, dd);
    }
  };
 ...
 */
//# sourceMappingURL=draw rect.js.map
