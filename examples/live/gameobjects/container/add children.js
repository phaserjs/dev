...
void main (void)
{
  ...
  // examples/src/gameobjects/container/add children.ts
  ...
  var game = new Game(WebGL(), GlobalVar("Phaser4"), Size2(800, 600), Parent("gameParent"), BackgroundColor(2960685), Scenes(Demo));
