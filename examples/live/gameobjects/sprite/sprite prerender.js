...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/gameobjects/sprite/sprite prerender.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddTween(star).to(3200, { x: 650 }).yoyo(true).repeat(-1).easing(easing_exports.Back.InOut);
      AddTween(star).to(2e3, { y: 450 }).yoyo(true).repeat(-1).easing(easing_exports.Sine.InOut);
 ...
 */
//# sourceMappingURL=sprite prerender.js.map
