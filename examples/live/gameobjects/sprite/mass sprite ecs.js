...
void main (void)
{
  ...
  // d:/wamp/www/phaser-genesis/src/components/AddComponent.ts
  function AddComponent(component, eid, world2 = GameObjectWorld) {
    addComponent(world2, component, eid);
  }

  // d:/wamp/www/phaser-genesis/src/components/DataTypes.ts
  var DataTypes = Types;

  // d:/wamp/www/phaser-genesis/src/components/DefineComponent.ts
  function DefineComponent(schema) {
    return defineComponent(schema);
  }

  // d:/wamp/www/phaser-genesis/src/components/DefineQuery.ts
  function DefineQuery(components2) {
    return defineQuery(components2);
  }

  // d:/wamp/www/phaser-genesis/src/components/DefineSystem.ts
  function DefineSystem(update, world2 = GameObjectWorld) {
    const system = defineSystem(update);
    return () => system(world2);
  }
  ...
  // d:/wamp/www/dev/examples/src/gameobjects/sprite/mass sprite ecs.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        const updateParticlesSystem = DefineSystem((world3) => {
          const entities = getParticlesQuery(world3);
          for (let i = 0; i < entities.length; i++) {
            const id = entities[i];
  ...
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(526472), Scenes(Demo));
})();
/**
 ...
 */
//# sourceMappingURL=mass sprite ecs.js.map
