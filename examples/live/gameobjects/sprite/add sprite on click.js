...
void main (void)
{
  ...
  // Users/rich/Documents/GitHub/dev/examples/src/gameobjects/sprite/add sprite on click.ts
    ...
    constructor() {
      ...
      loader.start().then(() => {
        ...
        On(mouse, "pointerdown", (x, y, button) => {
          AddChild(world2, new Sprite(x, y, "red"));
        });
      });
    }
  };
 ...
 */
//# sourceMappingURL=add sprite on click.js.map
