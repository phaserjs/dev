...
void main (void)
{
  ...
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      this.addLabel(world2, original, "Original");
      this.addLabel(world2, variation1, "Technicolor");
      this.addLabel(world2, variation2, "Tint");
      this.addLabel(world2, variation3, "VintagePinhole");
    }
    addLabel(world2, sprite, label) {
      const text = new Text(sprite.x - 160, sprite.y + 108, label);
      text.setOrigin(0, 0);
      SetPadding(0, 0, 8, 8, text);
      AddChild(world2, text);
    }
  };
