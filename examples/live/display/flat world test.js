...
void main (void)
{
  ...
  // ../phaser-genesis/src/components/transform/InvalidateTransform2DComponent.ts
  function InvalidateTransform2DComponent(id) {
  ...
  // ../phaser-genesis/src/world/FlatWorld.ts
  var FlatWorld = class extends BaseWorld {
    type = "FlatWorld";
    transformQuery;
    constructor(scene) {
      super(scene);
  ...
  // ../phaser-genesis/src/world/SortWorldList.ts
  function SortWorldList(world2, property) {
    const children = GameObjectTree.get(world2.id);
    children.sort((a, b) => {
      const childA = GameObjectCache.get(a);
      const childB = GameObjectCache.get(b);
      return childA[property] - childB[property];
    });
    SetDirtyDisplayList(world2.id);
  }
  ...
  // examples/src/display/flat world test.ts
  var Slider = class extends Sprite {
    speed;
  ...
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      for (let i = 0; i < 512; i++) {
        ...
        AddChild(world2, new Slider(x, y, "glove"));
      }
      SortWorldList(world2, "speed");
    }
  };
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(657930), Scenes(Demo));
})();
//# sourceMappingURL=flat world test.js.map
