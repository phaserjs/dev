...
void main (void)
{
  ...
  // Users/rich/Documents/GitHub/phaser-genesis/src/math/mat2d/Matrix2D.ts
  var Matrix2D = class {
    a;
    b;
    c;
  ...
  // Users/rich/Documents/GitHub/phaser-genesis/src/math/mat2d/Mat2dAppend.ts
  ...
  // Users/rich/Documents/GitHub/phaser-genesis/src/math/mat2d/Mat2dGlobalToLocal.ts
  ...
  // Users/rich/Documents/GitHub/phaser-genesis/src/input/mouse/Mouse.ts
  ...
  // Users/rich/Documents/GitHub/dev/examples/src/display/add child to parent on click.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        AddChild(world2, parent1);
        AddChild(world2, parent2);
        ...
        On(mouse, "pointerdown", (x, y) => {
          if (x < 400) {
            ...
            AddTween(red).to(1e3, { rotation: Math.PI * 2 }).repeat(-1);
          }
        });
      });
    }
 ...
 */
//# sourceMappingURL=add child to parent on click.js.map
