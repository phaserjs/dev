...
void main (void)
{
  ...
  var WebGLRenderer = class {
    ...
    render(dirtyWorld, scenes) {
      ...
      ProcessBindingQueue();
      if (this.optimizeRedraw && dirtyWorld) {
        return;
      }
    ...
    step(time) {
      ...
      if (!this.isPaused) {
        ...
        if (this.willRender) {
          ...
          renderer.render(sceneManager.dirtyWorld, sceneManager.scenes);
        }
      }
      this.frame++;
  ...
  // examples/src/display/add over time.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        AddChild(world3, new Sprite(400, 300, "redfrog"));
        let t = 0;
        let i = 1;
        On(world3, "update", (delta) => {
          t += delta;
          if (t > 25 && i < 2048) {
 ...
 * @license      {@link https://opensource.org/licenses/MIT|MIT License}
 */
//# sourceMappingURL=add over time.js.map
