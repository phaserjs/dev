...
void main (void)
{
  ...
  // Users/rich/Documents/GitHub/phaser-genesis/src/math/Between.ts
  function Between(min, max) {
    return Math.floor(Math.random() * (max - min + 1) + min);
  }

  // Users/rich/Documents/GitHub/phaser-genesis/src/math/FloatBetween.ts
  ...
  // Users/rich/Documents/GitHub/dev/examples/src/display/mass child test.ts
  var Pixel = class extends Sprite {
    constructor(x, y) {
      super(x, y, "pixel");
