...
void main (void)
{
  ...
  function ImageFile(key, url, requestInit, glConfig) {
    return __async(this, null, function* () {
      ...
      if (!textureManager || textureManager.has(key) && textureManager.get(key).locked) {
        ...
        try {
          ...
          if (file.response.ok) {
            const blob = yield file.response.blob();
  ...
  function MultiplyLocalWithWorld(parentID, id) {
    const world2 = Transform2DComponent.world[parentID];
    const [pa, pb, pc, pd, ptx, pty] = world2;
  ...
  var UpdateLocalTransform2DSystem = (id, world2, query) => {
  ...
  // examples/src/display/mass child test.ts
  var Carrot = class extends Sprite {
    constructor(x, y) {
      super(x, y, "carrot");
      ...
      return __async(this, null, function* () {
        ...
        setInterval(() => {
          ...
          for (let i = 0; i < 5e3; i++) {
            ...
            AddChild(world2, new Carrot(x, y));
            total++;
          }
 ...
 */
//# sourceMappingURL=mass child test.js.map
