...
void main (void)
{
  ...
  // ../phaser-genesis/src/loader/files/BinaryFile.ts
  ...
  // ../phaser-genesis/src/loader/files/LoadBinaryFile.ts
  ...
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddChild(world2, text2);
      AddChild(world2, text3);
      console.log(file);
    }
  ...
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(29372), DefaultOrigin(0, 0), Scenes(Demo));
})();
/**
