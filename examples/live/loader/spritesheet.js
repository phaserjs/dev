...
void main (void)
{
  ...
  // examples/src/loader/spritesheet.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddChild(world2, new Sprite(200, 200, "tiles", 31));
      AddChild(world2, new Sprite(400, 200, "tiles", 32));
      AddChild(world2, new Sprite(600, 200, "tiles", 42));
      AddChild(world2, new Sprite(200, 400, "tiles", 49));
      AddChild(world2, new Sprite(400, 400, "tiles", 54));
      AddChild(world2, new Sprite(600, 400, "tiles", 55));
    }
  };
