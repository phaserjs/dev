...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/loader/atlas.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddChild(world2, new Sprite(200, 200, "items", "coin-silver-1"));
      AddChild(world2, new Sprite(400, 200, "items", "pouch-1"));
      AddChild(world2, new Sprite(600, 200, "items", "gem-1"));
      AddChild(world2, new Sprite(200, 400, "items", "heart-1"));
      AddChild(world2, new Sprite(400, 400, "items", "star-1"));
      AddChild(world2, new Sprite(600, 400, "items", "meat-1"));
    }
  };
