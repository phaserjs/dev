...
void main (void)
{
  ...
  // d:/wamp/www/phaser-genesis/src/loader/files/LoadCSVFile.ts
  ...
  // d:/wamp/www/phaser-genesis/src/loader/files/LoadSpriteSheetFile.ts
  ...
  // d:/wamp/www/dev/examples/src/loader/csv.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      mapData.forEach((tile) => {
        if (tile !== -1) {
          AddChild(world2, new Sprite(x, y, "tiles", tile));
        }
        x += 64;
        if (x === 1024) {
          x = 0;
  ...
  new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960776), Scenes(Demo));
})();
/**
