...
void main (void)
{
  ...
  // examples/src/tweens/tween 2.ts
  var Demo = class extends Scene {
    constructor() {
      ...
      loader.start().then(() => {
        ...
        AddTween(logo).to(3e3, { y: 500, rotation: 0 }).easing(bounce_exports.Out).repeat(100);
        AddTween(rocket).delay(2e3).to(1500, { x: 800 }).easing(quadratic_exports.In);
        AddTween(bubble).from(2e3, { y: "-600" }).yoyo().easing(bounce_exports.Out).repeat(2, 2e3).hold(500).delay(1e3);
        AddChildren(world2, logo, rocket, bubble);
      });
    }
  };
 ...
 * @license      {@link https://opensource.org/licenses/MIT|MIT License}
 */
//# sourceMappingURL=tween 2.js.map
