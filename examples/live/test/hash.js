...
void main (void)
{
  ...
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      const addItem = () => {
        ...
        AddChild(layer, new Sprite(x, y, "items", frame2).setOrigin(0.5, 1));
      };
  ...
  var game = new Game(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960781), Scenes(Demo));
  window["game"] = game;
})();
/**
