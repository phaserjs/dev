(() => {
  ...
  // d:/wamp/www/phaser-genesis/src/config/worldsize/SetWorldSize.ts
  ...
  // d:/wamp/www/phaser-genesis/node_modules/bitecs/dist/index.es.js
  var TYPES_ENUM = {
    i8: "i8",
    ui8: "ui8",
    ui8c: "ui8c",
  ...
  // d:/wamp/www/phaser-genesis/src/components/transform/Extent2DComponent.ts
  ...
  // d:/wamp/www/phaser-genesis/src/components/color/PackQuadColorsSystem.ts
...
void main (void)
{
  ...
  // d:/wamp/www/phaser-genesis/src/components/bounds/BoundsComponent.ts
  ...
  // d:/wamp/www/phaser-genesis/src/components/bounds/AddBoundsComponent.ts
  function AddBoundsComponent(id) {
    addComponent(GameObjectWorld, BoundsComponent, id);
  }

  // d:/wamp/www/phaser-genesis/src/math/mat4/Matrix4Component.ts
  var Matrix4Component = defineComponent({
    data: [Types.f32, 16]
  });

  // d:/wamp/www/phaser-genesis/src/math/mat4/AddMatrix4Component.ts
  ...
  // d:/wamp/www/dev/examples/src/test/renderdraw.ts
  var MiniPhaser = class {
    renderer;
    textureManager;
    constructor() {
      SetConfigDefaults();
