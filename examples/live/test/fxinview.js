(() => {
  ...
  function AddChildren(parent, ...children2) {
  ...
  function SetParent(parent, ...children2) {
    children2.forEach((child) => {
...
void main (void)
{
  ...
  // ../phaser-genesis/src/components/permissions/SetWillRenderChildren.ts
 ...
 */
//# sourceMappingURL=fxinview.js.map
