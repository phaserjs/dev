...
void main (void)
{
  ...
  // ../phaser-genesis/src/Test.worker.ts
  function Worker2() {
    return inlineWorker('function o(m,t=0,r){r||(r=m.length);let e=t+Math.floor(Math.random()*r);return m[e]}function a(){return o(["Bob","Bill","Ben"])}postMessage(`Hello from ${a()}`);\n');
  }
  ...
  CreateGame(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960685), Scenes(Demo));
})();
/**
