...
void main (void)
{
  ...
  // ../phaser-genesis/src/math/angle/WrapAngle.ts
  function WrapAngle(angle) {
    return Wrap(angle, -Math.PI, Math.PI);
  }

  // ../phaser-genesis/src/camera/Camera.ts
  var Camera = class {
    constructor() {
      this._rotation = 0;
  ...
  // ../phaser-genesis/src/math/RadToDeg.ts
  ...
  var World2 = class extends BaseWorld {
    constructor(scene) {
      super(scene);
  ...
  // examples/src/camera/camera test 2.ts
  var Demo = class extends Scene {
    ...
    create() {
      ...
      for (let i = 0; i < 900; i++) {
        ...
        AddChild(world2, new Sprite(x, y, "fruits", f));
      }
      AddChild(world2, new Sprite(400, 300, "marker"));
      AddChild(world2, new Sprite(400 - 800, 300, "marker"));
      AddChild(world2, new Sprite(400 + 800, 300, "marker"));
      AddChild(world2, new Sprite(400, 300 - 600, "marker"));
      AddChild(world2, new Sprite(400 - 800, 300 - 600, "marker"));
      AddChild(world2, new Sprite(400 + 800, 300 - 600, "marker"));
      AddChild(world2, new Sprite(400, 300 + 600, "marker"));
      AddChild(world2, new Sprite(400 - 800, 300 + 600, "marker"));
      AddChild(world2, new Sprite(400 + 800, 300 + 600, "marker"));
      ...
      On(keyboard, "keydown-ArrowLeft", () => {
        world2.camera.position.x -= 4;
        console.log("left", world2.camera.position.x);
      });
      On(keyboard, "keydown-ArrowRight", () => {
        world2.camera.position.x += 4;
        console.log("right", world2.camera.position.x);
      });
      On(keyboard, "keydown-ArrowUp", () => {
        world2.camera.position.y -= 4;
        console.log("up", world2.camera.position.y);
      });
      On(keyboard, "keydown-ArrowDown", () => {
        world2.camera.position.y += 4;
        console.log("dw", world2.camera.position.y);
      });
      On(keyboard, "keydown-a", () => {
        world2.camera.rotation -= rot;
        console.log("rotation", world2.camera.rotation, RadToDeg(world2.camera.rotation));
      });
      ...
      On(keyboard, "keydown-w", () => {
        world2.camera.scale.x += 0.1;
        world2.camera.scale.y += 0.1;
      });
  ...
  new Game(MaxTextures(8), WebGL(), Size(800, 600), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960685), Scenes(Demo));
})();
/**
 ...
 * @license      {@link https://opensource.org/licenses/MIT|MIT License}
 */
//# sourceMappingURL=camera test 2.js.map
