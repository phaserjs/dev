...
void main (void)
{
  ...
  // examples/live/libs/phaser4debugkit/GameObject3DEditor.js
  var import_tweakpane = __toModule(require_tweakpane());
  var GameObject3DEditor = class {
    constructor(obj3D) {
      this.target = obj3D;
...
`;
  ...
  new Game(WebGL(), Size(800, 600), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(1907997), Scenes(Demo));
})();
