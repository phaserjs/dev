...
void main (void)
{
  ...
  // d:/wamp/www/phaser-genesis/src/renderer/webgl1/draw/DrawQuad.ts
  ...
  // d:/wamp/www/dev/examples/src/direct mode/draw quad.ts
  var Demo = class extends Scene {
    ...
    async create() {
      ...
      AddTween(topLeft).to(3e3, { x: 90, y: 70 }).yoyo(true).repeat(-1).easing(easing_exports.Sine.InOut);
      AddTween(bottomLeft).to(4e3, { x: 150, y: 400 }).yoyo(true).repeat(-1).easing(easing_exports.Sine.InOut);
      AddTween(bottomRight).to(2e3, { x: 520, y: 500 }).yoyo(true).repeat(-1).easing(easing_exports.Sine.InOut);
      AddTween(topRight).to(5e3, { x: 400, y: 20 }).yoyo(true).repeat(-1).easing(easing_exports.Sine.InOut);
