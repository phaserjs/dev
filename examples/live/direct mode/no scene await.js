...
void main (void)
{
  ...
  // d:/wamp/www/dev/examples/src/direct mode/no scene await.ts
  var MyGame = class {
    constructor() {
      this.create();
    }
    async create() {
      const game = await CreateGame(WebGL(), Parent("gameParent"), GlobalVar("Phaser4"), BackgroundColor(2960685));
