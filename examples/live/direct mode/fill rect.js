...
void main (void)
{
  ...
  // examples/src/direct mode/fill rect.ts
  var Demo = class extends Scene {
    constructor() {
      super();
      const world3 = new StaticWorld(this);
      On(world3, WorldPostRenderEvent, (renderPass) => {
        FillRect(renderPass, 100, 100, 340, 240, 16711680);
        FillRect(renderPass, 200, 200, 512, 64, 16776960, 0.6);
        FillRect(renderPass, 300, 300, 48, 210, 16711935);
      });
    }
  };
