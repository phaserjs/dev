...
class Demo extends Scene
{
    constructor ()
    {
        ...
        loader.start().then(() => {
            ...
            Play(lay, { repeat: -1, frameRate: 16, delay: 1000, repeatDelay: 4000 }, chicken1);
            Play(idle, { repeat: -1, frameRate: 24, repeatDelay: 1000 }, chicken2);
            Play(peck, { repeat: -1, frameRate: 24, delay: 2000, repeatDelay: 3000 }, chicken3);
