...
class Demo extends Scene
{
    ...
    async create ()
    {
        ...
        Effects.Technicolor(variation1);
        Effects.Tint(variation2, 0x00ff00);
        Effects.VintagePinhole(variation3);

        this.addLabel(world, original, 'Original');
        this.addLabel(world, variation1, 'Technicolor');
        this.addLabel(world, variation2, 'Tint');
        this.addLabel(world, variation3, 'VintagePinhole');
    }
