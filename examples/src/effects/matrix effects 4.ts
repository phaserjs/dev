...
class Demo extends Scene
{
    ...
    async create ()
    {
        ...
        Effects.Kodachrome(variation1);
        Effects.LSD(variation2);
        Effects.Negative(variation3);

        this.addLabel(world, original, 'Original');
        this.addLabel(world, variation1, 'Kodachrome');
        this.addLabel(world, variation2, 'LSD');
        this.addLabel(world, variation3, 'Negative');
    }
