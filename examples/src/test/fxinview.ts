...
const purpleHazeFragmentShader = `
precision mediump float;
...
class Demo extends Scene
{
    ...
    async create ()
    {
        ...
        for (let y = -worldSize; y < worldSize; y += 64)
        {
            ...
            {
                // AddChild(layer, new Sprite(x, y, 'bit').setAlpha(1.0));
